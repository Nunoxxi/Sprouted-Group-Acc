...
2. **Not persisted yet:** bank lines, matches and codings; intercompany transactions. These still live in component state and audit through `POST /api/audit` from the client.
