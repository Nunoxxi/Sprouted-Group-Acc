...
src/components/app/   app-shell.tsx — the UI shell with sidebar nav; inventory-panel.tsx — Inventory; buying-panel.tsx — agents and floats; contracts-panel.tsx — sales contracts and LBC; opening-panel.tsx — go-live; payments-panel.tsx — wallets, statements, farmer payments
