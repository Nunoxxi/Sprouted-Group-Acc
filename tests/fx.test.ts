...
function usdInvoice(unitPriceCents: number, quantity = 1): DocumentFormState {
  ...
  document.lines = [{ id: 'l1', description: 'Cocoa beans', quantity, unitPrice: unitPriceCents, accountCode: '4005', vatTreatment: 'zero-rated', itemId: null, locationId: null }];
  return document;
}
...
describe('a foreign invoice posted at one rate', () => {
  ...
  it('puts any rounding difference on the control line so the journal still balances', () => {
    ...
    document.lines = [{ id: 'a', description: 'x', quantity: 3, unitPrice: 33333, accountCode: '4005', vatTreatment: 'standard', itemId: null, locationId: null }];
